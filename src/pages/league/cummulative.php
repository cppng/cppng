...
if(isset($_GET['month'])){
    ...
    if(file_exists("../src/data/".$_GET['month']."_cumm.json")){
...
$string = file_get_contents("../src/data/".$month."_cumm.json");
        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <form class="form-inline">
                    ...
                    <?php echo ' <a href="/league/cummulative?='.$month.'_cumm" class="btn btn-blue btn-sm ml-2">
                    Cummulative
                    </a>'; ?>
                </form>
            </div>
