<div class="row">
    ...
    <div class="col-md-6 col-xl-6">
        ...
        <div class="card-body">
            ...
            <div class="col-6">
                <div
                class="avatar-lg rounded-circle bg-soft-pink border-pink border"
                >
                <i
                    class="fa fa-money font-22 avatar-title text-pink"
                ></i>
                </div>
            </div>
            <div class="col-6">
    ...
    <div class="col-md-6 col-xl-6">
        ...
        <div class="card-body">
            ...
            <div class="col-6">
                ...
                >
                <i
                    class="fa-compress-alt font-22 avatar-title text-blue"
                ></i>
                </div>
            </div>
            <div class="col-6">
    ...
    <div class="col-md-6 col-xl-6">
        ...
        <div class="card-body">
            ...
            <div class="col-6">
                ...
                >
                <i
                    class="fe-bar-chart-line- font-22 avatar-title text-success"
                ></i>
                </div>
            </div>
            <div class="col-6">
