                                        ...
                                        <table class="table table-borderless table-hover table-nowrap table-centered m-0">
                                            ...
                                            <thead class="thead-light">
                                                <tr>
                                                    ...
                                                    <th class="font-weight-medium">Febuary League Points</th>
                                            ...
                                            <tr class="text-white" style="background-color: #3e6551;">
                                                    ...
                                                    <td><h5 class="m-0 font-weight-normal"> MINISTRY OF JUSTICE - PLATEAU STATE  </h5></td>    
                                                    <td>10,150,000</td>    
                                                    <td>845,833 </td>    
                                                    <td>1495</td>    
                                                    <td>12</td>
                                                ...
                                                <tr class="bg-success">
                                                    ...
                                                    <td><h5 class="m-0 font-weight-normal"> COLLEGE OF HEALTH TECHNOLOGY, PANKSHIN</h5></td>    
                                                    <td>80,235,000</td>    
                                                    <td>6,686,250</td>    
                                                    <td>819</td>    
                                                    <td>248</td>
